    ...
    this.material = new THREE.ShaderMaterial({
      ...
      vertexShader: /* glsl */ `
        ...
        void main() {
          ...
          float shadowCos = cos(5.0 / max(lenBH, 1.0));
          float inFront = step(lenP, lenBH * 0.75); // 只留近侧
          float occl = smoothstep(shadowCos, shadowCos + 0.01, cosAng) * inFront;
          float vis = 1.0 - occl;
